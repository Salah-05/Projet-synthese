                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="image product-thumbnail"><img src="{{$command->products->first()->picture}}" alt="#"></td>
                                            
                                       
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="product-details.html">{{$command->products->first()->name}}</a></h5>
                                            <p class="font-xs">{{$command->products->first()->description}}<br> distingy magndapibus.
                                            </p>
                                        </td>
                                        <td class="price" data-title="Price"><span>{{$command->products->first()->price}}$ </span></td>
