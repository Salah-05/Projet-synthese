                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$productCount ?? 'none'}}</strong> items for you!</p>
                            </div>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <form action="{{ route('add_product', ['id' => $products->id]) }}" method="POST" id="add">
                                                @csrf
                                                <a href="" aria-label="Add To Cart" class="action-btn hover-up"><button type="submit" href="cart.html"><i class="fi-rs-shopping-bag-add"></i></button></a> 
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <div class="price-filter">
                                <form action="{{ route('filter',['searchQuery' => $searchQuery ?? '']) }}" method="GET" id="filterForm">
                                {{-- <form action="{{ route('filter',['searchQuery' => $searchQuery]) }}" method="GET" id="filterForm"> --}}
                                    @if($productCount > 1)
                                        <div class="price-filter-inner">
                                            ...
                                            <input type="hidden" id="minPriceInput" name="minPrice" value="{{ $minimumprice }}">
                                            <input type="hidden" id="maxPriceInput" name="maxPrice" value="{{ $maximumprice }}">
                                            {{-- <input type="hidden" name="products" value="{{$searchQuery}}"> --}}
                                        </div>
                                    @endif
                                
                                
                                <script>
                                    var minPrice = parseInt("{{ $minimumprice }}");
                                    var maxPrice = parseInt("{{ $maximumprice }}");
                                    var randMin = 0; // Your min range
                                    var randMax = 500; // Your max range
                                    ...
                                    $(function() {
                                        ...
                                        $( "#amount" ).val("$" + randMin + " - $" + randMax);
                                        $( "#minPriceInput" ).val(randMin);
                                        $( "#maxPriceInput" ).val(randMax);
                                    });
